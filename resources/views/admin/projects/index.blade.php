                ...
                <div class="card card-bordered" style="overflow: hidden">
                    <a href="{{ route('admin.projects.edit', ['project' => $project->id])}}">
                        <div class="card-block"
                             style="height: 270px;background-image: url({{@Storage::disk('public')->url('app/public/images/projects/'. $project->image)}});background-size: cover;background-position: center;">
                        </div>
                    </a>
